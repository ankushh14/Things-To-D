...
const Addtodo = () => {
  ...
  return (
    ...
    <div className="input-div w-full flex justify-center items-center space-y-4 lg:space-x-5 p-4 flex-col lg:flex-row">
        <input type="text" name="description" id="description" className='w-[80%] border-b-2 text-black lg:w-[60%] focus:outline-none p-3' autoComplete = 'off' placeholder='Enter a new todo..' value={todo} onChange={handleChange}/>
